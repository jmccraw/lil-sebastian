    ...
    "shareToTwitter": function() {
      ...
      if (settings.global.mobile) {
        window.location.href = "twitter://post?message=" + encodeURIComponent("I scored " + settings.global.score +
          " points in @Vulture's @ParksAndRecNBC #retrogame! #BeatThat " + window.location.href);
      }
      ...
      setTimeout(function() {
        window.open("http://twitter.com/intent/tweet" +
          ...
          " points in @Vulture's @ParksAndRecNBC #retrogame! #BeatThat") + "+" + encodeURIComponent(window.location.href), "Tweet Your Score",
